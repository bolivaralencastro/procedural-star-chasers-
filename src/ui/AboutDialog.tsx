...
interface AboutDialogProps {
  ...
  onClose: () => void;
  /** Game-core flag that pauses canvas input while the dialog is open. */
  inputDisabled?: WritableSignal<boolean>;
}
  ...
  return (
    <Show when={props.isOpen()}>
      ...
      <div class="fixed inset-0 z-50 flex items-center justify-center pointer-events-none p-4">
        <div class="bg-neutral-900/80 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl shadow-black/80 max-w-2xl w-full max-h-[85vh] overflow-y-auto no-scrollbar text-gray-200 pointer-events-auto flex flex-col ring-1 ring-white/5">
          {/* Header */}
